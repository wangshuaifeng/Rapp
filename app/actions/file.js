...
export function uploadFileP ({path, mime, size = 0, pixelSize = '',
  duration = 0, bucket = 'zqc-img'}, {timeout = 10000, background = false,
  onUploadProgress} = {}) {
  return dispatch => {
...
export function uploadFile ({path, mime, size = 0, pixelSize = '', duration = 0,
  bucket = 'zqc-img', cbOk}, {timeout = 10000, background = false,
  onUploadProgress} = {}) {
  return dispatch => {
